...
# ---------- Validation helpers ----------
def validate_hex_color(value: str, default: str = "#2563EB") -> str:
    """Ensure value is a 6-digit hex color like #RRGGBB. Return default if invalid."""
    if re.match(r'^#[0-9a-fA-F]{6}$', value):
        return value
    logging.warning(f"Invalid WIDGET_COLOR '{value}' — must be a 6-digit hex (e.g. #2563EB). Using default '{default}'.")
    return default
...
# ---------- WIDGET ----------
WIDGET_COLOR = validate_hex_color(os.getenv("WIDGET_COLOR", "#2563EB"))
